...
public class WGPUCreateRenderPipelineAsyncCallbackInfo extends WgpuJavaStruct {
	...
	*/
    public static WGPUCreateRenderPipelineAsyncCallbackInfo createDirect(){
        WGPUCreateRenderPipelineAsyncCallbackInfo struct = new WGPUCreateRenderPipelineAsyncCallbackInfo();
    ...
    public WGPUCreateRenderPipelineAsyncCallbackInfo setNextInChain(WGPUChainedStruct... x){
    ...
    public WGPUCreateRenderPipelineAsyncCallbackInfo setMode(WGPUCallbackMode val){
    ...
    public WGPUCreateRenderPipelineAsyncCallbackInfo setCallback(jnr.ffi.Pointer val){
    ...
    public WGPUCreateRenderPipelineAsyncCallbackInfo setUserdata(jnr.ffi.Pointer val){
