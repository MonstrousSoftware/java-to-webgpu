...
public class WGPURenderPassDescriptor extends WgpuJavaStruct {
    ...
    private final @Nullable DynamicStructRef<WGPURenderPassDepthStencilAttachment> depthStencilAttachment = new DynamicStructRef<>(WGPURenderPassDepthStencilAttachment.class);
    private final @Nullable Struct.Pointer occlusionQuerySet = new Struct.Pointer();
    private final @Nullable DynamicStructRef<WGPURenderPassTimestampWrites> timestampWrites = new DynamicStructRef<>(WGPURenderPassTimestampWrites.class);
	...
	*/
    ...
    public WGPURenderPassDescriptor setColorAttachmentCount(long val){
        this.colorAttachmentCount.set(val); return this;
    }
    ...
    public WGPURenderPassDescriptor setOcclusionQuerySet(jnr.ffi.Pointer val){
        this.occlusionQuerySet.set(val); return this;
    }
