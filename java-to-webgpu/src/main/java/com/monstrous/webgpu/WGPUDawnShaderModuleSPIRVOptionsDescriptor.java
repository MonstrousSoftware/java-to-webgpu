...
public class WGPUDawnShaderModuleSPIRVOptionsDescriptor extends WgpuJavaStruct {
    ...
    private final Struct.Unsigned32 allowNonUniformDerivatives = new Struct.Unsigned32();
	...
	*/
    public static WGPUDawnShaderModuleSPIRVOptionsDescriptor createDirect(){
        WGPUDawnShaderModuleSPIRVOptionsDescriptor struct = new WGPUDawnShaderModuleSPIRVOptionsDescriptor();
    ...
    public WGPUDawnShaderModuleSPIRVOptionsDescriptor setAllowNonUniformDerivatives(long val){
        this.allowNonUniformDerivatives.set(val); return this;
    }
