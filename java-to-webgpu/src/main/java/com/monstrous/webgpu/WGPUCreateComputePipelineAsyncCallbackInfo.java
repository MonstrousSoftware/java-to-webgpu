...
public class WGPUCreateComputePipelineAsyncCallbackInfo extends WgpuJavaStruct {
	...
	*/
    public static WGPUCreateComputePipelineAsyncCallbackInfo createDirect(){
        WGPUCreateComputePipelineAsyncCallbackInfo struct = new WGPUCreateComputePipelineAsyncCallbackInfo();
    ...
    public WGPUCreateComputePipelineAsyncCallbackInfo setNextInChain(WGPUChainedStruct... x){
    ...
    public WGPUCreateComputePipelineAsyncCallbackInfo setMode(WGPUCallbackMode val){
    ...
    public WGPUCreateComputePipelineAsyncCallbackInfo setCallback(jnr.ffi.Pointer val){
    ...
    public WGPUCreateComputePipelineAsyncCallbackInfo setUserdata(jnr.ffi.Pointer val){
