...
public class WGPURenderPipelineDescriptor extends WgpuJavaStruct {
    ...
    private final @Nullable Struct.Pointer layout = new Struct.Pointer();
    ...
    private final @Nullable DynamicStructRef<WGPUDepthStencilState> depthStencil = new DynamicStructRef<>(WGPUDepthStencilState.class);
