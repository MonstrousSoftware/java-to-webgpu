...
public class WGPURenderBundleDescriptor extends WgpuJavaStruct {
	...
	*/
    public static WGPURenderBundleDescriptor createDirect(){
        WGPURenderBundleDescriptor struct = new WGPURenderBundleDescriptor();
    ...
    public WGPURenderBundleDescriptor setNextInChain(WGPUChainedStruct... x){
    ...
    public WGPURenderBundleDescriptor setLabel(java.lang.String str){
