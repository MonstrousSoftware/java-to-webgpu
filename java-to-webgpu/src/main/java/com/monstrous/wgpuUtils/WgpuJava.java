...
import com.monstrous.webgpu.WebGPUUtils;
...
public class WgpuJava {
    ...
    public static WebGPUUtils init(){

        WebGPUUtils webGPU = LibraryLoader.create(WebGPUUtils.class).load("wrapper"); // load the library
