...
public class WGPURenderPassColorAttachment extends WgpuJavaStruct {
    ...
    private final @Nullable Struct.Pointer view = new Struct.Pointer();
    private final Struct.Unsigned32 depthSlice = new Struct.Unsigned32();
    private final @Nullable Struct.Pointer resolveTarget = new Struct.Pointer();
	...
	*/
    ...
    public WGPURenderPassColorAttachment setDepthSlice(long val){
        this.depthSlice.set(val); return this;
    }
    ...
    public WGPURenderPassColorAttachment setResolveTarget(jnr.ffi.Pointer val){
        this.resolveTarget.set(val); return this;
    }
    ...
    public WGPURenderPassColorAttachment setLoadOp(WGPULoadOp val){
        this.loadOp.set(val); return this;
    }
    ...
    public WGPURenderPassColorAttachment setStoreOp(WGPUStoreOp val){
        this.storeOp.set(val); return this;
    }
