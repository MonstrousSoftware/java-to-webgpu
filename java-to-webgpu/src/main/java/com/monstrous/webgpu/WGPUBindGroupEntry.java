...
public class WGPUBindGroupEntry extends WgpuJavaStruct {
    ...
    private final @Nullable Struct.Pointer buffer = new Struct.Pointer();
    private final Struct.Unsigned64 offset = new Struct.Unsigned64();
    private final Struct.Unsigned64 size = new Struct.Unsigned64();
    private final @Nullable Struct.Pointer sampler = new Struct.Pointer();
    private final @Nullable Struct.Pointer textureView = new Struct.Pointer();
	...
	*/
    ...
    public WGPUBindGroupEntry setTextureView(jnr.ffi.Pointer val){
        this.textureView.set(val); return this;
    }
