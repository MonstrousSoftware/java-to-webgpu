...
public class WGPUCompilationMessage extends WgpuJavaStruct {
    ...
    private final @Nullable @CStrPointer Struct.Pointer message = new Struct.Pointer();
    private final Struct.Enum<WGPUCompilationMessageType> type = new Struct.Enum<>(WGPUCompilationMessageType.class);
    private final Struct.Unsigned64 lineNum = new Struct.Unsigned64();
    private final Struct.Unsigned64 linePos = new Struct.Unsigned64();
    private final Struct.Unsigned64 offset = new Struct.Unsigned64();
    private final Struct.Unsigned64 length = new Struct.Unsigned64();
    private final Struct.Unsigned64 utf16LinePos = new Struct.Unsigned64();
    private final Struct.Unsigned64 utf16Offset = new Struct.Unsigned64();
    private final Struct.Unsigned64 utf16Length = new Struct.Unsigned64();
	...
	*/
    ...
    public WGPUCompilationMessage setMessage(java.lang.String str){
        this.message.set(RustCString.toPointer(str)); return this;
    }
    ...
    public WGPUCompilationMessage setLineNum(@jnr.ffi.types.u_int64_t long val){
        this.lineNum.set(val); return this;
    }
    ...
    public WGPUCompilationMessage setLinePos(@jnr.ffi.types.u_int64_t long val){
        this.linePos.set(val); return this;
    }
    ...
    public WGPUCompilationMessage setLength(@jnr.ffi.types.u_int64_t long val){
        this.length.set(val); return this;
    }
    ...
    public WGPUCompilationMessage setUtf16LinePos(@jnr.ffi.types.u_int64_t long val){
        this.utf16LinePos.set(val); return this;
    }
    ...
    public WGPUCompilationMessage setUtf16Offset(@jnr.ffi.types.u_int64_t long val){
        this.utf16Offset.set(val); return this;
    }
    ...
    public WGPUCompilationMessage setUtf16Length(@jnr.ffi.types.u_int64_t long val){
        this.utf16Length.set(val); return this;
    }
