...
public class WGPUDawnWGSLBlocklist extends WgpuJavaStruct {
	...
	*/
    public static WGPUDawnWGSLBlocklist createDirect(){
        var struct = new WGPUDawnWGSLBlocklist();
    ...
    public void setBlocklistedFeatureCount(long x){
        this.blocklistedFeatureCount.set(x);
    }
    ...
    public void setBlocklistedFeatures(jnr.ffi.Pointer x){
        this.blocklistedFeatures.set(x);
    }
