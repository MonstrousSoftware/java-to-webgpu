...
public class WGPUShaderModuleWGSLDescriptor extends WgpuJavaStruct {
	...
	*/
    public static WGPUShaderModuleWGSLDescriptor createDirect(){
        WGPUShaderModuleWGSLDescriptor struct = new WGPUShaderModuleWGSLDescriptor();
    ...
    public WGPUShaderModuleWGSLDescriptor setCode(java.lang.String str){
        this.code.set(RustCString.toPointer(str)); return this;
    }
