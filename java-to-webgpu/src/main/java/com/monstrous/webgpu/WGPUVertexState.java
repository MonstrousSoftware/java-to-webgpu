...
public class WGPUVertexState extends WgpuJavaStruct {
    ...
    private final @Nullable @CStrPointer Struct.Pointer entryPoint = new Struct.Pointer();
    ...
    private final Struct.size_t bufferCount = new Struct.size_t();
	...
	*/
    ...
    public WGPUVertexState setBufferCount(long val){
        this.bufferCount.set(val); return this;
    }
